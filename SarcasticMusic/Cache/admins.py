...
from SarcasticMusic import SUDO_USERS, app
from SarcasticMusic.Helpers.Database import get_authuser_names, is_nonadmin_chat
                ...
                if message.from_user.id not in SUDO_USERS:
                    ...
                    if token not in _check:
                        return await message.reply(
                            "**» You don't have permission to manage video chat so be in your limit babes 😅**"
                        )
